...
3. **Keep every line shareable:** own words; ticket/PR IDs as bare references; no code, secrets, hostnames, customer data, or internal-system detail beyond what is safe to share outside the company.
